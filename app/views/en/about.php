...
<main class="about-page page-width">
            <div class="heading">
                <h1>ABOUT EVENT</h1>
                <p class="subheading">SAFE is annually organized by the Miners Kladno baseball and softball club.</p>
            </div>
            <div class="about-container">
                <section class="aboutpage">
                    ...
                    <div class="about-content">
                        ...
                        SAFE is also a thank you to our <a href="<?= url('sponsors') ?>" class="site-links">sponsors</a>, fans, parents and our entire Miners Family for their endless support without which we could not do what we do.
            ...
            <div class="about-container">
                <section class="aboutpage">
                    <div class="about-image">
                        <img src="<?= asset('images/about/kino-sokol1.jpg') ?>" alt="Cinema Sokol">
                    </div>
                    <div class="about-content">
                        <h2 id="location">When and where?</h2>
                        <p>SAFE is traditionally held after the end of the season.</p>
                        <p><strong>WHEN:</strong> <?= $terminText ? e($terminText) : 'The date has not been set.' ?></p>
                        <p><strong>ADDRESS:</strong> <a target="_blank" href="https://www.google.com/maps/place//data=!4m2!3m1!1s0x470bb7da602a6c4b:0xe7204d94c85ab6b1?sa=X&ved=1t:8290&ictx=111">T. G. Masaryka 2320, 272 01 Kladno 1</a></p>
                        <p><strong>HOW TO FIND US:</strong> Cinema Sokol is located in Kladno near nám. Svobody in the pedestrian zone. You can get to us by city or Prague buses (all buses stop on the square)</p>
                    </div>
                </section>
            </div>
            <hr>
