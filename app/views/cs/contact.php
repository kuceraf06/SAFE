        ...
        <div class="contact-box">
            ...
            <div class="contact-panel contact-panel-cs">
                ...
                <form class="contact-form" method="post" autocomplete="off">
                    ...
                    <input type="email" name="email" class="field" placeholder="Vaše e-mailová adresa*" required>
        ...
        <div class="contact-methods">
            <div class="contact-method">
                ...
                <article class="contact-text">
                    <h2 class="contact-label">Adresa</h2>
