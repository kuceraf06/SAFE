<footer class="footer">
    <div class="footer-content">
        <div class="footer-container">
            <div class="row-footer">
                ...
                <img src="<?= $baseUrl ?>images/SAFE-logo.png">
                </div>
                <div class="footer-col">
                    <h4>DALŠÍ WEBY</h4>
                    <ul>
                        <li><a href="https://minerskladno.cz" target="_blank">MINERS</a></li>
                ...
                <div class="footer-col">
                    ...
                    <div class="contact-footer">
                        <p><a href="mailto:safe@minerkladno.cz" target="_blank">safe@minerskladno.cz</a></p>
                        <p>Miners Kladno, z.s.
                            <br>
                            U Trati 3489
                            <br>
    ...
    <div class="copyright">
        <a href="mailto:safe@minerkladno.cz">Miners Kladno 2025 &copy; Všechna práva vyhrazena</a>
    </div>
</footer>