    <div class="topheader">
        ...
        <div class="header-icons">
            <a href="https://softball.cz" target="_blank"><img src="<?= $baseUrl ?>images/softballczech.png"/></a>
            <a href="https://www.baseball.cz" target="_blank"><img src="<?= $baseUrl ?>images/baseballczech.png"/></a>
            <a href="https://www.flickr.com/photos/201375961@N07/albums" target="_blank"><img src="<?= $baseUrl ?>images/flickr.png"/></a>
            <a href="https://www.facebook.com/minerskladno" target="_blank"><img src="<?= $baseUrl ?>images/FB.png"/></a>
            <a href="https://www.instagram.com/minerskladno/" target="_blank"><img src="<?= $baseUrl ?>images/IG.png"/></a>
        </div>
    </div>
    <header class="header mobile-header">
        <a href="<?= $baseUrl ?>"><img id="logo" src="<?= $baseUrl ?>images/logo-SAFE.png"></a>
