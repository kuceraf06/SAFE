...
<html lang="cs">
    <head>
        ...
        <script src="https://cdn.tiny.cloud/1/qmps7etbzn8s7reyh3pw6xc2h2dszx17s4ehfjj2gwkcsrxp/tinymce/8/tinymce.min.js" referrerpolicy="origin" crossorigin="anonymous"></script>
        <script>
            tinymce.init({
                selector: '#eventTitle',
                toolbar: false,
