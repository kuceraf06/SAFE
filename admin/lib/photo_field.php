 ...
 * @param string $size        'normal' nebo 'large' (větší náhled – např. pozvánka)
 */
function scm_photo_upload_field(string $baseUrl, string $currentPhoto, string $shape = 'round', string $size = 'normal'): void
{
    $squareClass = $shape === 'square' ? ' is-square' : '';
    $squareClass .= $size === 'large' ? ' is-large' : '';
