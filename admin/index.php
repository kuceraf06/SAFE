...
<div class="content">
    ...
    <h2>Spustit rezervaci</h2>
        ...
        <div class="addBox">
            <div class="firstBox">
                <a href="<?= $baseUrl ?>admin/udalosti/pridat/" class="childBox">
                    <i class='bx bx-plus'></i>
                    <p>Přidat novou událost</p>
                </a>
                <a href="<?= $baseUrl ?>admin/program/pridat/" class="childBox childBox-2">
                    <i class='bx bx-plus'></i>
                    <p>Přidat nový program</p>
                </a>
            </div>
            <div class="secondBox">
                <a href="<?= $baseUrl ?>admin/termin/" class="childBox">
                    <i class='bx bx-plus'></i>
                    <p>Aktualizovat termín</p>
                </a>
                <a href="<?= $baseUrl ?>admin/pozvanka/" class="childBox childBox-2">
                    <i class='bx bx-plus'></i>
